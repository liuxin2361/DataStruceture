...
class LinkedList:
    ...
    def append(self, value):
        ...
        if not self.next:  # 如果没有节点时
            ...
            self.next.next = node  # 将新节点挂到最后一个节点
        self.next = node
        self.size += 1
    ...
    def append_first(self, value):
        ...
        if not self.next:
            ...
            temp = self.root.next  # 获取原来root后面的节点
            self.root.next = node  # 将新节点挂到root上
            node.next = temp  # 新的节点的下一个节点是原来root后的节点
        self.size += 1
